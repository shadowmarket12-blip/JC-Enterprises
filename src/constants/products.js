...
const RAW_PRODUCTS = [
...

  {
    ...
    colors: [
      ...
      },
      {
        ...
        hex: "#a86a44",
        images: [
          "/allfan/Fan image 3/Atomberg Renesa Halo [sweep]mm smart ceiling fan copper haze – JC Enterprises Bhubaneswar.webp",
        ],
      },
      {
        name: "Spring Green",
        hex: "#6b8f5a",
        images: [
          "/allfan/Fan image 3/Atomberg Renesa Halo [sweep]mm smart ceiling fan spring green– JC Enterprises Bhubaneswar.webp",
        ],
      },
      ...
      },
      {
        ...
        hex: "#b0aea6",
        images: [
          "/allfan/Fan image 3/Atomberg Renesa Halo [sweep]mm smart ceiling fan pebble grey– JC Enterprises Bhubaneswar.webp",
        ],
      },
      {
        ...
        hex: "#e7dcc4",
        images: [
          "/allfan/Fan image 3/Atomberg Renesa Halo [sweep]mm smart ceiling fan sea sand ivory and black– JC Enterprises Bhubaneswar.webp",
        ],
      },
      {
        ...
        hex: "#3a2a20",
        images: [
          "/allfan/Fan image 3/Atomberg Renesa Halo [sweep]mm smart ceiling fan matte brown and black– JC Enterprises Bhubaneswar.webp",
        ],
      },
      {
    ...
    metaTitle: "Atomberg Renesa Halo 1200mm – Buy Online Bhubaneswar",
    metaDescription:
      "Get the Atomberg Renesa Halo 1200mm online in Bhubaneswar, finished in Misty Teal and Aegean Blue with Smart App control. Genuine, home delivery – JC Enterprises.",
    description:
      "A smart BLDC ceiling fan with a signature ring-light (RG Ring) design around the fan body, offered in an extensive colour palette across four sweep sizes — a statement piece for living rooms and premium bedrooms.",
    features: [
      "Genuine Atomberg smart BLDC fan",
...

  {
    ...
    metaTitle: "Atomberg Renesa Halo 600mm – Buy Online Bhubaneswar",
    metaDescription:
      "Order the Atomberg Renesa Halo 600mm in Misty Teal and Gloss White (RG Ring) online in Bhubaneswar, smart control. Genuine, home delivery – JC Enterprises.",
    description:
      "A smart BLDC ceiling fan with a signature ring-light (RG Ring) design around the fan body, offered in an extensive colour palette across four sweep sizes — a statement piece for living rooms and premium bedrooms.",
    features: [
      "Genuine Atomberg smart BLDC fan",
